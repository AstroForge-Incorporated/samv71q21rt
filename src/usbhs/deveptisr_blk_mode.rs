...
pub type R = crate::R<DeveptisrBlkModeSpec>;
...
#[doc = "Device Endpoint Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptisr_blk_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptisrBlkModeSpec;
impl crate::RegisterSpec for DeveptisrBlkModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr_blk_mode::R`](R) reader structure"]
impl crate::Readable for DeveptisrBlkModeSpec {}
#[doc = "`reset()` method sets DEVEPTISR_BLK_MODE[%s] to value 0"]
impl crate::Resettable for DeveptisrBlkModeSpec {}
