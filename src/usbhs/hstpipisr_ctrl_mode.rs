...
pub type R = crate::R<HstpipisrCtrlModeSpec>;
...
#[doc = "Host Pipe Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipisr_ctrl_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipisrCtrlModeSpec;
impl crate::RegisterSpec for HstpipisrCtrlModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr_ctrl_mode::R`](R) reader structure"]
impl crate::Readable for HstpipisrCtrlModeSpec {}
#[doc = "`reset()` method sets HSTPIPISR_CTRL_MODE[%s] to value 0"]
impl crate::Resettable for HstpipisrCtrlModeSpec {}
