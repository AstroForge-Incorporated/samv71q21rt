...
pub type W = crate::W<HstpipierBlkModeSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rxines(&mut self) -> RxinesW<HstpipierBlkModeSpec> {
        RxinesW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmitted OUT Data Interrupt Enable"]
    #[inline(always)]
    pub fn txoutes(&mut self) -> TxoutesW<HstpipierBlkModeSpec> {
        TxoutesW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmitted SETUP Interrupt Enable"]
    #[inline(always)]
    pub fn txstpes(&mut self) -> TxstpesW<HstpipierBlkModeSpec> {
        TxstpesW::new(self, 2)
    }
    #[doc = "Bit 3 - Pipe Error Interrupt Enable"]
    #[inline(always)]
    pub fn perres(&mut self) -> PerresW<HstpipierBlkModeSpec> {
        PerresW::new(self, 3)
    }
    #[doc = "Bit 4 - NAKed Interrupt Enable"]
    #[inline(always)]
    pub fn nakedes(&mut self) -> NakedesW<HstpipierBlkModeSpec> {
        NakedesW::new(self, 4)
    }
    #[doc = "Bit 5 - Overflow Interrupt Enable"]
    #[inline(always)]
    pub fn overfies(&mut self) -> OverfiesW<HstpipierBlkModeSpec> {
        OverfiesW::new(self, 5)
    }
    #[doc = "Bit 6 - Received STALLed Interrupt Enable"]
    #[inline(always)]
    pub fn rxstalldes(&mut self) -> RxstalldesW<HstpipierBlkModeSpec> {
        RxstalldesW::new(self, 6)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Enable"]
    #[inline(always)]
    pub fn shortpacketies(&mut self) -> ShortpacketiesW<HstpipierBlkModeSpec> {
        ShortpacketiesW::new(self, 7)
    }
    #[doc = "Bit 12 - Number of Busy Banks Enable"]
    #[inline(always)]
    pub fn nbusybkes(&mut self) -> NbusybkesW<HstpipierBlkModeSpec> {
        NbusybkesW::new(self, 12)
    }
    #[doc = "Bit 16 - Pipe Interrupts Disable HDMA Request Enable"]
    #[inline(always)]
    pub fn pdishdmas(&mut self) -> PdishdmasW<HstpipierBlkModeSpec> {
        PdishdmasW::new(self, 16)
    }
    #[doc = "Bit 17 - Pipe Freeze Enable"]
    #[inline(always)]
    pub fn pfreezes(&mut self) -> PfreezesW<HstpipierBlkModeSpec> {
        PfreezesW::new(self, 17)
    }
    #[doc = "Bit 18 - Reset Data Toggle Enable"]
    #[inline(always)]
    pub fn rstdts(&mut self) -> RstdtsW<HstpipierBlkModeSpec> {
        RstdtsW::new(self, 18)
    }
}
#[doc = "Host Pipe Enable Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipier_blk_mode::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipierBlkModeSpec;
impl crate::RegisterSpec for HstpipierBlkModeSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`hstpipier_blk_mode::W`](W) writer structure"]
impl crate::Writable for HstpipierBlkModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HSTPIPIER_BLK_MODE[%s] to value 0"]
impl crate::Resettable for HstpipierBlkModeSpec {}
