...
pub type Epen9R = crate::BitReader;
#[doc = "Field `EPEN9` writer - Endpoint 9 Enable"]
pub type Epen9W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Eprst9R = crate::BitReader;
#[doc = "Field `EPRST9` writer - Endpoint 9 Reset"]
pub type Eprst9W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 9 - Endpoint 9 Enable"]
    #[inline(always)]
    pub fn epen9(&mut self) -> Epen9W<DeveptSpec> {
        Epen9W::new(self, 9)
    }
    #[doc = "Bit 16 - Endpoint 0 Reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - Endpoint 9 Reset"]
    #[inline(always)]
    pub fn eprst9(&mut self) -> Eprst9W<DeveptSpec> {
        Eprst9W::new(self, 25)
    }
}
