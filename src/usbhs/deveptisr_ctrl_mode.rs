...
pub type R = crate::R<DeveptisrCtrlModeSpec>;
...
#[doc = "Device Endpoint Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptisr_ctrl_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptisrCtrlModeSpec;
impl crate::RegisterSpec for DeveptisrCtrlModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr_ctrl_mode::R`](R) reader structure"]
impl crate::Readable for DeveptisrCtrlModeSpec {}
#[doc = "`reset()` method sets DEVEPTISR_CTRL_MODE[%s] to value 0"]
impl crate::Resettable for DeveptisrCtrlModeSpec {}
