...
impl W {
    ...
    #[inline(always)]
    pub fn dma_7(&mut self) -> Dma7W<DevidrSpec> {
        Dma7W::new(self, 31)
    }
}
#[doc = "Device Global Interrupt Disable Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devidr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate::Resettable for DevidrSpec {}
