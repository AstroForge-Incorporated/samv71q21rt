...
impl W {
    #[doc = "Bits 0:7 - IN Request Number before Freeze"]
    #[inline(always)]
    pub fn inrq(&mut self) -> InrqW<HstpipinrqSpec> {
        InrqW::new(self, 0)
    }
    #[doc = "Bit 8 - IN Request Mode"]
    #[inline(always)]
    pub fn inmode(&mut self) -> InmodeW<HstpipinrqSpec> {
        InmodeW::new(self, 8)
    }
}
#[doc = "Host Pipe IN Request Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipinrq::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipinrq::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets HSTPIPINRQ[%s] to value 0"]
impl crate::Resettable for HstpipinrqSpec {}
