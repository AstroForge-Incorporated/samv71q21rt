...
pub type R = crate::R<HstpipimrIntrptModeSpec>;
...
#[doc = "Host Pipe Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipimr_intrpt_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipimrIntrptModeSpec;
impl crate::RegisterSpec for HstpipimrIntrptModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr_intrpt_mode::R`](R) reader structure"]
impl crate::Readable for HstpipimrIntrptModeSpec {}
#[doc = "`reset()` method sets HSTPIPIMR_INTRPT_MODE[%s] to value 0"]
impl crate::Resettable for HstpipimrIntrptModeSpec {}
