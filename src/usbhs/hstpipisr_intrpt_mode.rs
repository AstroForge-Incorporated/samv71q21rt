...
pub type R = crate::R<HstpipisrIntrptModeSpec>;
...
#[doc = "Host Pipe Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipisr_intrpt_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipisrIntrptModeSpec;
impl crate::RegisterSpec for HstpipisrIntrptModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr_intrpt_mode::R`](R) reader structure"]
impl crate::Readable for HstpipisrIntrptModeSpec {}
#[doc = "`reset()` method sets HSTPIPISR_INTRPT_MODE[%s] to value 0"]
impl crate::Resettable for HstpipisrIntrptModeSpec {}
