...
pub type R = crate::R<DeveptimrIsoModeSpec>;
...
#[doc = "Device Endpoint Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptimr_iso_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptimrIsoModeSpec;
impl crate::RegisterSpec for DeveptimrIsoModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr_iso_mode::R`](R) reader structure"]
impl crate::Readable for DeveptimrIsoModeSpec {}
#[doc = "`reset()` method sets DEVEPTIMR_ISO_MODE[%s] to value 0"]
impl crate::Resettable for DeveptimrIsoModeSpec {}
