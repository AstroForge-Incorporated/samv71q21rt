...
pub type R = crate::R<DeveptimrCtrlModeSpec>;
...
#[doc = "Device Endpoint Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptimr_ctrl_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptimrCtrlModeSpec;
impl crate::RegisterSpec for DeveptimrCtrlModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr_ctrl_mode::R`](R) reader structure"]
impl crate::Readable for DeveptimrCtrlModeSpec {}
#[doc = "`reset()` method sets DEVEPTIMR_CTRL_MODE[%s] to value 0"]
impl crate::Resettable for DeveptimrCtrlModeSpec {}
