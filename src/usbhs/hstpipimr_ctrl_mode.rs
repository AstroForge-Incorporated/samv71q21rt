...
pub type R = crate::R<HstpipimrCtrlModeSpec>;
...
#[doc = "Host Pipe Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipimr_ctrl_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipimrCtrlModeSpec;
impl crate::RegisterSpec for HstpipimrCtrlModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr_ctrl_mode::R`](R) reader structure"]
impl crate::Readable for HstpipimrCtrlModeSpec {}
#[doc = "`reset()` method sets HSTPIPIMR_CTRL_MODE[%s] to value 0"]
impl crate::Resettable for HstpipimrCtrlModeSpec {}
