...
pub type R = crate::R<DeveptimrIntrptModeSpec>;
...
#[doc = "Device Endpoint Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptimr_intrpt_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptimrIntrptModeSpec;
impl crate::RegisterSpec for DeveptimrIntrptModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr_intrpt_mode::R`](R) reader structure"]
impl crate::Readable for DeveptimrIntrptModeSpec {}
#[doc = "`reset()` method sets DEVEPTIMR_INTRPT_MODE[%s] to value 0"]
impl crate::Resettable for DeveptimrIntrptModeSpec {}
