...
pub type R = crate::R<DevdmacontrolSpec>;
#[doc = "Register `DEVDMACONTROL` writer"]
pub type W = crate::W<DevdmacontrolSpec>;
...
impl W {
    #[doc = "Bit 0 - Channel Enable Command"]
    #[inline(always)]
    pub fn chann_enb(&mut self) -> ChannEnbW<DevdmacontrolSpec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Load Next Channel Transfer Descriptor Enable Command"]
    #[inline(always)]
    pub fn ldnxt_dsc(&mut self) -> LdnxtDscW<DevdmacontrolSpec> {
        LdnxtDscW::new(self, 1)
    }
    #[doc = "Bit 2 - End of Transfer Enable Control (OUT transfers only)"]
    #[inline(always)]
    pub fn end_tr_en(&mut self) -> EndTrEnW<DevdmacontrolSpec> {
        EndTrEnW::new(self, 2)
    }
    #[doc = "Bit 3 - End of Buffer Enable Control"]
    #[inline(always)]
    pub fn end_b_en(&mut self) -> EndBEnW<DevdmacontrolSpec> {
        EndBEnW::new(self, 3)
    }
    #[doc = "Bit 4 - End of Transfer Interrupt Enable"]
    #[inline(always)]
    pub fn end_tr_it(&mut self) -> EndTrItW<DevdmacontrolSpec> {
        EndTrItW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Buffer Interrupt Enable"]
    #[inline(always)]
    pub fn end_buffit(&mut self) -> EndBuffitW<DevdmacontrolSpec> {
        EndBuffitW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Interrupt Enable"]
    #[inline(always)]
    pub fn desc_ld_it(&mut self) -> DescLdItW<DevdmacontrolSpec> {
        DescLdItW::new(self, 6)
    }
    #[doc = "Bit 7 - Burst Lock Enable"]
    #[inline(always)]
    pub fn burst_lck(&mut self) -> BurstLckW<DevdmacontrolSpec> {
        BurstLckW::new(self, 7)
    }
    #[doc = "Bits 16:31 - Buffer Byte Length (Write-only)"]
    #[inline(always)]
    pub fn buff_length(&mut self) -> BuffLengthW<DevdmacontrolSpec> {
        BuffLengthW::new(self, 16)
    }
}
#[doc = "Device DMA Channel Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`devdmacontrol::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devdmacontrol::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DevdmacontrolSpec;
impl crate::RegisterSpec for DevdmacontrolSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmacontrol::R`](R) reader structure"]
impl crate::Readable for DevdmacontrolSpec {}
#[doc = "`write(|w| ..)` method takes [`devdmacontrol::W`](W) writer structure"]
impl crate::Writable for DevdmacontrolSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVDMACONTROL to value 0"]
impl crate::Resettable for DevdmacontrolSpec {}
