...
pub type R = crate::R<DevdmastatusSpec>;
#[doc = "Register `DEVDMASTATUS` writer"]
pub type W = crate::W<DevdmastatusSpec>;
...
impl W {
    #[doc = "Bit 0 - Channel Enable Status"]
    #[inline(always)]
    pub fn chann_enb(&mut self) -> ChannEnbW<DevdmastatusSpec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    pub fn chann_act(&mut self) -> ChannActW<DevdmastatusSpec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    pub fn end_tr_st(&mut self) -> EndTrStW<DevdmastatusSpec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    pub fn end_bf_st(&mut self) -> EndBfStW<DevdmastatusSpec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    pub fn desc_ldst(&mut self) -> DescLdstW<DevdmastatusSpec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    pub fn buff_count(&mut self) -> BuffCountW<DevdmastatusSpec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "Device DMA Channel Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`devdmastatus::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devdmastatus::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DevdmastatusSpec;
impl crate::RegisterSpec for DevdmastatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmastatus::R`](R) reader structure"]
impl crate::Readable for DevdmastatusSpec {}
#[doc = "`write(|w| ..)` method takes [`devdmastatus::W`](W) writer structure"]
impl crate::Writable for DevdmastatusSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVDMASTATUS to value 0"]
impl crate::Resettable for DevdmastatusSpec {}
