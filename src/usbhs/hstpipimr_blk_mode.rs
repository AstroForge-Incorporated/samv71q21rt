...
pub type R = crate::R<HstpipimrBlkModeSpec>;
...
#[doc = "Host Pipe Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipimr_blk_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipimrBlkModeSpec;
impl crate::RegisterSpec for HstpipimrBlkModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr_blk_mode::R`](R) reader structure"]
impl crate::Readable for HstpipimrBlkModeSpec {}
#[doc = "`reset()` method sets HSTPIPIMR_BLK_MODE[%s] to value 0"]
impl crate::Resettable for HstpipimrBlkModeSpec {}
