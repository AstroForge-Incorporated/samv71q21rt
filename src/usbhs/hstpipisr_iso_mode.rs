...
pub type R = crate::R<HstpipisrIsoModeSpec>;
...
#[doc = "Host Pipe Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipisr_iso_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipisrIsoModeSpec;
impl crate::RegisterSpec for HstpipisrIsoModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr_iso_mode::R`](R) reader structure"]
impl crate::Readable for HstpipisrIsoModeSpec {}
#[doc = "`reset()` method sets HSTPIPISR_ISO_MODE[%s] to value 0"]
impl crate::Resettable for HstpipisrIsoModeSpec {}
