...
pub type R = crate::R<HstpipimrIsoModeSpec>;
...
#[doc = "Host Pipe Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipimr_iso_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipimrIsoModeSpec;
impl crate::RegisterSpec for HstpipimrIsoModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr_iso_mode::R`](R) reader structure"]
impl crate::Readable for HstpipimrIsoModeSpec {}
#[doc = "`reset()` method sets HSTPIPIMR_ISO_MODE[%s] to value 0"]
impl crate::Resettable for HstpipimrIsoModeSpec {}
