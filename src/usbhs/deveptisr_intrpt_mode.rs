...
pub type R = crate::R<DeveptisrIntrptModeSpec>;
...
#[doc = "Device Endpoint Interrupt Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptisr_intrpt_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptisrIntrptModeSpec;
impl crate::RegisterSpec for DeveptisrIntrptModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr_intrpt_mode::R`](R) reader structure"]
impl crate::Readable for DeveptisrIntrptModeSpec {}
#[doc = "`reset()` method sets DEVEPTISR_INTRPT_MODE[%s] to value 0"]
impl crate::Resettable for DeveptisrIntrptModeSpec {}
