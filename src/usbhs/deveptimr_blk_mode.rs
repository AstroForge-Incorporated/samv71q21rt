...
pub type R = crate::R<DeveptimrBlkModeSpec>;
...
#[doc = "Device Endpoint Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptimr_blk_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptimrBlkModeSpec;
impl crate::RegisterSpec for DeveptimrBlkModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr_blk_mode::R`](R) reader structure"]
impl crate::Readable for DeveptimrBlkModeSpec {}
#[doc = "`reset()` method sets DEVEPTIMR_BLK_MODE[%s] to value 0"]
impl crate::Resettable for DeveptimrBlkModeSpec {}
