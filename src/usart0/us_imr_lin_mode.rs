...
pub type R = crate::R<UsImrLinModeSpec>;
...
#[doc = "Interrupt Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`us_imr_lin_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UsImrLinModeSpec;
impl crate::RegisterSpec for UsImrLinModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`us_imr_lin_mode::R`](R) reader structure"]
impl crate::Readable for UsImrLinModeSpec {}
#[doc = "`reset()` method sets US_IMR_LIN_MODE to value 0"]
impl crate::Resettable for UsImrLinModeSpec {}
