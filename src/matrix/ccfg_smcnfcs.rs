...
pub type SdramenR = crate::BitReader;
#[doc = "Field `SDRAMEN` writer - SDRAM Enable"]
pub type SdramenW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 4 - SDRAM Enable"]
    #[inline(always)]
    pub fn sdramen(&mut self) -> SdramenW<CcfgSmcnfcsSpec> {
        SdramenW::new(self, 4)
    }
}
