...
pub type AllonesR = crate::FieldReader<u16>;
#[doc = "Field `ALLONES` writer - Must Always Be Written with 0xFFF"]
pub type AllonesW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
...
impl R {
    ...
    pub fn allones(&self) -> AllonesR {
        AllonesR::new(((self.bits >> 16) & 0x0fff) as u16)
    }
...
impl W {
    ...
    #[doc = "Bits 16:27 - Must Always Be Written with 0xFFF"]
    #[inline(always)]
    pub fn allones(&mut self) -> AllonesW<MrSpec> {
        AllonesW::new(self, 16)
    }
    #[doc = "Bit 28 - Watchdog Debug Halt"]
    #[inline(always)]
