...
pub type R = crate::R<EefcWpmrSpec>;
#[doc = "Register `EEFC_WPMR` writer"]
pub type W = crate::W<EefcWpmrSpec>;
...
impl W {
    #[doc = "Bit 0 - Write Protection Enable"]
    #[inline(always)]
    pub fn wpen(&mut self) -> WpenW<EefcWpmrSpec> {
        WpenW::new(self, 0)
    }
    #[doc = "Bits 8:31 - Write Protection Key"]
    #[inline(always)]
    pub fn wpkey(&mut self) -> WpkeyW<EefcWpmrSpec> {
        WpkeyW::new(self, 8)
    }
}
#[doc = "Write Protection Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`eefc_wpmr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eefc_wpmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EefcWpmrSpec;
impl crate::RegisterSpec for EefcWpmrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eefc_wpmr::R`](R) reader structure"]
impl crate::Readable for EefcWpmrSpec {}
#[doc = "`write(|w| ..)` method takes [`eefc_wpmr::W`](W) writer structure"]
impl crate::Writable for EefcWpmrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EEFC_WPMR to value 0"]
impl crate::Resettable for EefcWpmrSpec {}
