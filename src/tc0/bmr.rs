...
pub type AutocR = crate::BitReader;
#[doc = "Field `AUTOC` writer - AutoCorrection of missing pulses"]
pub type AutocW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn autoc(&self) -> AutocR {
        AutocR::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn maxcmp(&self) -> MaxcmpR {
        MaxcmpR::new(((self.bits >> 26) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - External Clock Signal 0 Selection"]
    ...
    #[doc = "Bit 18 - AutoCorrection of missing pulses"]
    #[inline(always)]
    pub fn autoc(&mut self) -> AutocW<BmrSpec> {
        AutocW::new(self, 18)
    }
    #[doc = "Bits 20:25 - Maximum Filter"]
    #[inline(always)]
    ...
    #[doc = "Bits 26:29 - Maximum Consecutive Missing Pulses"]
    #[inline(always)]
    pub fn maxcmp(&mut self) -> MaxcmpW<BmrSpec> {
        MaxcmpW::new(self, 26)
    }
}
