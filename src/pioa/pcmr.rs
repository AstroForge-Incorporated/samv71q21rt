...
impl DsizeR {
    ...
    pub const fn variant(&self) -> Option<Dsizeselect> {
        match self.bits {
            0 => Some(Dsizeselect::Byte),
            1 => Some(Dsizeselect::Halfword),
            2 => Some(Dsizeselect::Word),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn byte(self) -> &'a mut crate::W<REG> {
        self.variant(Dsizeselect::Byte)
    }
    #[doc = "The reception data in the PIO_PCRHR is a half-word (16-bit)"]
    #[inline(always)]
    pub fn halfword(self) -> &'a mut crate::W<REG> {
        self.variant(Dsizeselect::Halfword)
    }
    #[doc = "The reception data in the PIO_PCRHR is a word (32-bit)"]
    #[inline(always)]
    pub fn word(self) -> &'a mut crate::W<REG> {
        self.variant(Dsizeselect::Word)
    }
}
