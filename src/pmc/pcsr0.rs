...
#[doc = "Peripheral Clock Status Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pcsr0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcsr0Spec;
impl crate::RegisterSpec for Pcsr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcsr0::R`](R) reader structure"]
impl crate::Readable for Pcsr0Spec {}
#[doc = "`reset()` method sets PCSR0 to value 0"]
impl crate::Resettable for Pcsr0Spec {}
